const theme = {
    colorNeutralBlack: "#0E0E12",
    colorNeutralDarkest: "#141418",
    ...
    colorRaibownFourth: "#947DBB",
    colorRaibownFifth: "#F896C3",
    colorRaibownSixth: "#FFCC7D",
    colorRaibownSeventh: "#FFE659",
    ...
    fontFamilyHighlight: "'Coolvetica'",
